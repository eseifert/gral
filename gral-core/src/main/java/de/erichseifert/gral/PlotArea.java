...
public abstract class PlotArea extends AbstractDrawable
	...
	public static final Key BACKGROUND = new Key("plotarea.background"); //$NON-NLS-1$
	/** Key for specifying the {@link java.awt.Stroke} instance to be used to
	paint the border of the plot area. */
	public static final Key BORDER = new Key("plotarea.border"); //$NON-NLS-1$
	/** Key for specifying the {@link java.awt.Paint} instance to be used to
	fill the border of the plot area. */
	public static final Key COLOR = new Key("plotarea.color"); //$NON-NLS-1$
	...
	public static final Key CLIPPING = new Key("plotarea.clipping"); //$NON-NLS-1$
