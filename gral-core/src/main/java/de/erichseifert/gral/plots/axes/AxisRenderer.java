...
public interface AxisRenderer extends SettingsStorage {
	...
	/** Key for specifying a {@link java.lang.Boolean} value which decides
	 ...
	 or labels. */
	Key SHAPE_VISIBLE = new Key("axis.shape.visible");
	/** Key for specifying a {@link java.lang.Boolean} value which decides
	...
	Key SHAPE_COLOR = new Key("axis.shape.color");
	/** Key for specifying the {@link java.awt.Stroke} instance which define
	 the shape of the axis. */
	Key SHAPE_STROKE = new Key("axis.shape.stroke");
	/** Key for specifying a {@link java.lang.Boolean} value which decides
	...
	Key TICKS = new Key("axis.ticks.major");
	/** Key for specifying a {@link java.lang.Number} value for the interval
	 for major ticks. */
	Key TICKS_SPACING = new Key("axis.ticks.major.spacing");
	...
	Key TICKS_LENGTH = new Key("axis.ticks.major.length");
	/** Key for specifying the {@link java.awt.Stroke} instance which is used
	 to draw all major ticks. */
	Key TICKS_STROKE = new Key("axis.ticks.major.stroke");
	...
	Key TICKS_ALIGNMENT = new Key("axis.ticks.major.alignment");
	/** Key for specifying the {@link java.awt.Paint} instance to be used to
	 paint the shapes of major ticks. */
	Key TICKS_COLOR = new Key("label.color");
	/** Key for specifying whether tick labels are drawn. */
	Key TICK_LABELS = new Key("axis.ticks.major.labels");
	...
	Key TICKS_MINOR = new Key("axis.ticks.minor");
	/** Key for specifying an {@link java.lang.Integer} value for the count
	 of minor ticks. */
	Key TICKS_MINOR_COUNT = new Key("axis.ticks.minor.count");
	...
	Key TICKS_MINOR_LENGTH = new Key("axis.ticks.minor.length");
	/** Key for specifying the {@link java.awt.Stroke} instance which is used
	 to draw all minor ticks. */
	Key TICKS_MINOR_STROKE = new Key("axis.ticks.minor.stroke");
	/** Key for specifying a {@link java.lang.Number} value for the alignment
