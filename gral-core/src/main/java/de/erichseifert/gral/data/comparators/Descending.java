...
public class Descending extends DataComparator {
	 ...
	 * <ul>
	 *   <li>a negative value means {@code row1} is larger than {@code row2}</li>
	 *   <li>0 means {@code row1} is equal to {@code row2}</li>
	 *   <li>a positive value means {@code row1} is smaller than {@code row2}</li>
	 * </ul>
	 * @param row1 First value
	 * @param row2 Second value
	 * @return An integer number describing the order:
	 *         a negative value if {@code row1} is larger than {@code row2},
	 *         0 if {@code row1} is equal to {@code row2},
	 *         a positive value if {@code row1} is smaller than {@code row2},
	 */
