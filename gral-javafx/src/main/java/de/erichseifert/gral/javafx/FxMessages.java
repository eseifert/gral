...
/**
 * <p>Lookup of the user-facing texts of the JavaFX components, translated
 ...
 * makes the bundle name {@code de.erichseifert.gral.javafx.messages}.</p>
 *
 ...
 */
final class FxMessages {
	/** Name of the resource bundle that contains the message texts. */
	private static final String BUNDLE_NAME =
			"de.erichseifert.gral.javafx.messages"; //$NON-NLS-1$
